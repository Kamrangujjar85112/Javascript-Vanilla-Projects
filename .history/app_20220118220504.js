...
const firstClass = document.getElementById('ist');
const secondClass = document.getElementById('2nd');
const thirdClass = document.getElementById('3rd');
const fourthClass = document.getElementById('4th');

const classValue = firstClass.className;
