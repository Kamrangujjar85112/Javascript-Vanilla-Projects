...
button.addEventListener('pressenter' , function converter(){
    const mile  = 1.609;
    const kiloMeters = Km.value * mile;
    alert(Km.value +' Miles are equal to ' +kiloMeters + ' KiloMeters');
    console.log(Km.value +' Miles are equal to ' +kiloMeters + ' KiloMeters');
    document.body.innerHTML = Km.value +' Miles are equal to ' +kiloMeters + ' KiloMeters';
});