...
// });
// // ---------------------------------------------------------------------
// const miles = document.getElementById('number');
// const button = document.getElementById('btn');

// button.addEventListener('click' , function converter(){
//     const mile  = 1.609;
//     const  inputMiles= miles.value;
//     const calculatedKM = inputMiles * mile;
//     alert('press OK to watch');
//     document.body.innerHTML = inputMiles +' Miles are equal to ' +calculatedKM + ' KiloMeters';
// });
// // ---------------------------------------------------------------------
...
const res = document.getElementById('rupees');

calc.addEventListener('click', function cash(){
    const inputdollar = dollar.value; 
    const inputrupee = rupee.value; 
    const amount = inputdollar * inputrupee;
    document.getElementById("rupees").innerHTML = inputdollar +' Dollars are equal to ' +amount + ' Rupees';
