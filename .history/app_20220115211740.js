...
const value = Math.random(); // below zero form 0.00 to 0.99
const value = Math.random() * 10; // from 0 to 9
const value = Math.floor(Math.random()); // roundabout of value always show zero if taken of value less than 1
const value = Math.ceil(Math.random()); // roundabout of +1 value
const value = Math.floor(Math.random() * 10); // roundabout from 0 to 9 if taken the value below 1
const value = Math.sqrt(); // to take the squareroot of the value
