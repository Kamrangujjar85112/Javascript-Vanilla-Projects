...
const result = document.querySelector('#resullt');
const bodyDiv = document.body.createElement('div');
const text = document.createTextNode('hey this is new div');
bodyDiv.appendChild(text);
result.appendChild(bodyDiv);


const heading = document.createElement('h2');
const headingText = document.createTextNode('its heading 4');
heading.appendChild(headingText);
heading.classList.add('blue');
document.body.result.appendChild(heading);  