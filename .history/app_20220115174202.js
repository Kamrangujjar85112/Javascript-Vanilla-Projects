...
// const isArray =[1,2,3,3,4,"kamran"]

// const newArray = isArray.map((arraykaData)=>{
//     if (arraykaData === 2) {
//         return "ali"
//     }
//     return arraykaData
...
// Object
// const newObject = {name:"hamid",age:22}
...
const newArray = firstArray.map(function (data) {

    // change Hamza to Muneeb

    const replaceName = {name:'Muneeb' , role: '.Net Developer'};
    if (data.name === "Hamza" ){
        return replaceName;
    }
    ...
    const replaceRole = {name:'Hamid' , role: 'Full-stack Developer'};
    ...
    const addRole = {name:'ali' , role: 'laravel Developer'}
    if (data === "ali") {
        return addRole;
    }
    return data;
