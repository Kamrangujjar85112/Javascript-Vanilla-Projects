...
// const value = Math.floor(Math.random(number)); // roundabout of value always show zero if taken of value less than 1
// const value = Math.ceil(Math.random(number)); // roundabout of +1 value
// const value = Math.floor(Math.random(number) * 10); // roundabout from 0 to 9 if taken the value below 1
